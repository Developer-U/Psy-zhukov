        ...
        <ul class="digits__list digits-list d-grid grid-four">
            <?php if ($digits_first['digit']) { ?>
                <li class="digits-list__item digits-item">
                    <h2 class="digits-item__digit js-count position-relative">
            ...
            if ($digits_third['description']) { ?>
                <li class="digits-list__item digits-item">
                    <figure class="digits-item__image">
                        <img src="<?php echo $digits_third['image']['url']; ?>"
                            alt="<?php echo $digits_third['image']['alt']; ?>">
                    </figure>
            ...
            if ($digits_fourth['description']) { ?>
                <li class="digits-list__item digits-item">
                    <figure class="digits-item__image">
                        <img src="<?php echo $digits_fourth['image']['url']; ?>"
                            alt="<?php echo $digits_fourth['image']['alt']; ?>">
                    </figure>
